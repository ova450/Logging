...
Namespace Model
    ...
    'Public Class Component : Inherits EventLoggingAbstract : Implements INavigationChild(Of BaseEvent)
    ...
    'Public Class Process : Inherits EventLoggingAbstract : Implements INavigationChild(Of BaseEvent)
    '    Public Overrides Function EventId() As EventId
    ...
    'Public Class Stage : Inherits EventLoggingAbstract : Implements INavigationChild(Of BaseEvent)
    '    Public Overrides Function EventId() As EventId
    ...
    'Public Class BaseEvent : Inherits EventLoggingAbstract : Implements INavigationParent(Of Component, Process, Stage)
